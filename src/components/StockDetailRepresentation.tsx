    ...
    <>
      ...
      <p>
        <label htmlFor="fiftyDayAverageChange">
          ...
          <span id="fiftyDayAverageChange">{props.fiftyDayAverageChange}</span>
        </label>
      </p>
      <p>
      ...
      <p>
        <label htmlFor="twoHundredDayAverage">
          ...
          <span id="twoHundredDayAverage">{props.twoHundredDayAverage}</span>
        </label>
      </p>
      <p>
      ...
      <p>
        <label htmlFor="exchangeTimezoneName">
          ...
          <span id="exchangeTimezoneName">{props.exchangeTimezoneName}</span>
        </label>
      </p>
      <p>
      ...
      <p>
        <label htmlFor="gmtOffSetMilliseconds">
          ...
          <span id="gmtOffSetMilliseconds">{props.gmtOffSetMilliseconds}</span>
        </label>
      </p>
      <p>
      ...
      <p>
        <label htmlFor="regularMarketDayRange">
          ...
          <span id="regularMarketDayRange">{props.regularMarketDayRange}</span>
        </label>
      </p>
      <p>
      ...
      <p>
        <label htmlFor="fiftyTwoWeekLowChange">
          ...
          <span id="fiftyTwoWeekLowChange">{props.fiftyTwoWeekLowChange}</span>
        </label>
      </p>
      <p>
      ...
      <p>
        <label htmlFor="exchangeDataDelayedBy">
          ...
          <span id="exchangeDataDelayedBy">{props.exchangeDataDelayedBy}</span>
        </label>
      </p>
      <p>
      ...
      <p>
        <label htmlFor="regularMarketDayHigh">
          ...
          <span id="regularMarketDayHigh">{props.regularMarketDayHigh}</span>
        </label>
      </p>
      <p>
